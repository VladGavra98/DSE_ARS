...
airport = 1 #which airport
#1 = one runway partial
#2 = two runways, parallel, partial
#3 = three runways
#4 = one runway all the way through

run = True #run the segmentation script
...
#Runway coordinates1
if airport == 1:
    rwy36Lcoords = [(-1000,-1700), (-1001,11700), (-1001+212,11701), (-1000+212,-1701)] #no direct veritcal or horizotnal lines
    rwy24coords = [(-10000,-10000),(-10001,-10001),(-10004,-9999),(-10020,-9921),(-10104,-9299)]
if airport == 2:
    rwy36Lcoords =  [(-1000,-1700), (-1001-5000,11700), (-1001+212-5000,11701), (-1000+212,-1701)]#no direct veritcal or horizotnal lines
    rwy24coords = [(0,+1000), (212,1000), (212+5000,-11701), (5001,-11700),(5000,-11701)]
if airport == 3:
    rwy36Lcoords =  [(-1000,-1700), (-1001-5000,11700), (-1001+212-5000,11701), (-1000+212,-1701)]#no direct veritcal or horizotnal lines
    spx = 1000
    rwy24coords = [(0,+1000), (212,1000), (212+5000,-11701), (212+5000+spx,-11701), (0+spx,+1000), (212+spx,1000), (212+5000+spx,-10991),  (5000,-11701)]
if airport == 4:
    rwy36Lcoords = [(-10000,-10000),(-10000+212,-10000),(-9000+212,-10000),(-9000,-10000)] #no direct veritcal or horizotnal lines
    rwy24coords = [(-10000,-10000),(-10001,-10001),(-10004,-9999),(-10020,-9921),(-10104,-9299)]
...
rwy24finish1 = np.array(((rwy24coords[-1][0]-dxc),(rwy24coords[-1][1]-dyc)))
...
#plt.savefig('2_PP_Segmented_V2_600_AirportVar1.png',dpi=600)
